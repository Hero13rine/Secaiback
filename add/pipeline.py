...
def step2_train_shadow(config: PipelineConfig):
    """
    ...
    # Load dataloaders from load_dataset module (no path parameters - uses defaults)
    ...
    # For shadow training: use TEST as training data, VAL for validation
...
def step3_train_attack(config: PipelineConfig):
    """
...
def step4_evaluate(config: PipelineConfig):
    """
